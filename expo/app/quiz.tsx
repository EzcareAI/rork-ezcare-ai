...
const questions = [
  ...
  },
  {
    ...
    type: 'select',
    options: ['+1 (US/Canada)', '+44 (UK)', '+33 (France)', '+49 (Germany)', '+81 (Japan)', '+86 (China)', '+91 (India)', '+61 (Australia)', '+55 (Brazil)', '+7 (Russia)', '+34 (Spain)', '+39 (Italy)', '+31 (Netherlands)', '+46 (Sweden)', '+47 (Norway)', '+45 (Denmark)', '+41 (Switzerland)', '+43 (Austria)', '+32 (Belgium)', '+351 (Portugal)', '+30 (Greece)', '+48 (Poland)', '+420 (Czech Republic)', '+36 (Hungary)', '+40 (Romania)', '+359 (Bulgaria)', '+385 (Croatia)', '+386 (Slovenia)', '+421 (Slovakia)', '+370 (Lithuania)', '+371 (Latvia)', '+372 (Estonia)', '+358 (Finland)', '+354 (Iceland)', '+353 (Ireland)', '+356 (Malta)', '+357 (Cyprus)', '+352 (Luxembourg)', '+377 (Monaco)', '+378 (San Marino)', '+379 (Vatican)', '+380 (Ukraine)', '+375 (Belarus)', '+373 (Moldova)', '+382 (Montenegro)', '+383 (Kosovo)', '+387 (Bosnia)', '+389 (Macedonia)', '+381 (Serbia)', '+90 (Turkey)', '+98 (Iran)', '+964 (Iraq)', '+966 (Saudi Arabia)', '+971 (UAE)', '+974 (Qatar)', '+973 (Bahrain)', '+968 (Oman)', '+965 (Kuwait)', '+962 (Jordan)', '+963 (Syria)', '+961 (Lebanon)', '+972 (Israel)', '+970 (Palestine)', '+20 (Egypt)', '+212 (Morocco)', '+213 (Algeria)', '+216 (Tunisia)', '+218 (Libya)', '+221 (Senegal)', '+223 (Mali)', '+224 (Guinea)', '+225 (Ivory Coast)', '+226 (Burkina Faso)', '+227 (Niger)', '+228 (Togo)', '+229 (Benin)', '+230 (Mauritius)', '+231 (Liberia)', '+232 (Sierra Leone)', '+233 (Ghana)', '+234 (Nigeria)', '+235 (Chad)', '+236 (Central African Republic)', '+237 (Cameroon)', '+238 (Cape Verde)', '+239 (Sao Tome)', '+240 (Equatorial Guinea)', '+241 (Gabon)', '+242 (Republic of Congo)', '+243 (Democratic Republic of Congo)', '+244 (Angola)', '+245 (Guinea-Bissau)', '+246 (British Indian Ocean Territory)', '+247 (Ascension Island)', '+248 (Seychelles)', '+249 (Sudan)', '+250 (Rwanda)', '+251 (Ethiopia)', '+252 (Somalia)', '+253 (Djibouti)', '+254 (Kenya)', '+255 (Tanzania)', '+256 (Uganda)', '+257 (Burundi)', '+258 (Mozambique)', '+260 (Zambia)', '+261 (Madagascar)', '+262 (Reunion)', '+263 (Zimbabwe)', '+264 (Namibia)', '+265 (Malawi)', '+266 (Lesotho)', '+267 (Botswana)', '+268 (Swaziland)', '+269 (Comoros)', '+290 (Saint Helena)', '+291 (Eritrea)', '+297 (Aruba)', '+298 (Faroe Islands)', '+299 (Greenland)', '+350 (Gibraltar)', '+500 (Falkland Islands)', '+501 (Belize)', '+502 (Guatemala)', '+503 (El Salvador)', '+504 (Honduras)', '+505 (Nicaragua)', '+506 (Costa Rica)', '+507 (Panama)', '+508 (Saint Pierre and Miquelon)', '+509 (Haiti)', '+590 (Guadeloupe)', '+591 (Bolivia)', '+592 (Guyana)', '+593 (Ecuador)', '+594 (French Guiana)', '+595 (Paraguay)', '+596 (Martinique)', '+597 (Suriname)', '+598 (Uruguay)', '+599 (Netherlands Antilles)', '+670 (East Timor)', '+672 (Australian External Territories)', '+673 (Brunei)', '+674 (Nauru)', '+675 (Papua New Guinea)', '+676 (Tonga)', '+677 (Solomon Islands)', '+678 (Vanuatu)', '+679 (Fiji)', '+680 (Palau)', '+681 (Wallis and Futuna)', '+682 (Cook Islands)', '+683 (Niue)', '+684 (American Samoa)', '+685 (Samoa)', '+686 (Kiribati)', '+687 (New Caledonia)', '+688 (Tuvalu)', '+689 (French Polynesia)', '+690 (Tokelau)', '+691 (Micronesia)', '+692 (Marshall Islands)']
  },
  {
    id: 'phone',
  ...
  },
  {
    ...
    type: 'select',
    options: ['Never', 'Occasionally', '1-2 drinks per week', '3+ drinks per week']
  },
  {
    id: 'stress',
...
export default function QuizPage() {
  ...
  const handleNext = () => {
    ...
    if (!currentAnswer || currentAnswer.trim() === '') {
      Alert.alert('Please answer the question', 'This field is required to continue.');
      return;
    }
  ...
  const generateRecommendations = (data: QuizData, bmi: number, healthScore: number): string[] => {
    const recommendations: string[] = [];

    if (bmi >= 25) {
      recommendations.push('Consider a balanced diet and regular exercise to achieve a healthy weight');
    } else if (bmi < 18.5) {
    ...
    if (data.sleep === 'Less than 5 hours' || data.sleep === '5-6 hours') {
      recommendations.push('Aim for 7-9 hours of quality sleep each night for optimal health');
    }
    ...
    if (data.smoking === 'Daily' || data.smoking === 'Occasionally') {
      recommendations.push('Consider quitting smoking - your body will thank you!');
    }
    ...
    if (recommendations.length === 0) {
      recommendations.push('Keep up the great work! Maintain your healthy lifestyle habits');
      recommendations.push('Consider regular health check-ups with your healthcare provider');
      recommendations.push('Stay hydrated and maintain good mental health practices');
    }
  ...
  const handleSubmit = async () => {
    if (!user) {
      Alert.alert('Please sign in', 'You need to be signed in to save your quiz results.');
      return;
    }
    ...
    try {
      ...
      const recommendations = generateRecommendations(quizData, bmi, healthScore);
      ...
      <View style={styles.navigation}>
        ...
        >
          <Text style={styles.nextButtonText}>
            {isSubmitting ? 'Calculating...' : currentQuestion === questions.length - 1 ? 'Get Results' : 'Next'}
          </Text>
