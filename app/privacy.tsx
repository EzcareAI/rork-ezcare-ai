      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            Ez, our AI health buddy{"\n"}• Usage Data: How you interact with our
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            infrastructure with enterprise-grade protection
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            with applicable health privacy regulations
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            continued use of EZCare AI after changes become effective
