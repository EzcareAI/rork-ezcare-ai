      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <View style={styles.heroContent}>
            <Text style={styles.heroTitle}>
              Your AI health buddy — meet Ez.
            </Text>
            <Text style={styles.heroSubtitle}>
              Clarity in seconds. Simple explanations, wellness tips, no
              judgement.
            </Text>
          ...
          <View style={styles.stepsContainer}>
            <View style={styles.step}>
              ...
              <Text style={styles.stepText}>
                Quick questions about your health, lifestyle, and wellness goals
              </Text>
            </View>
            <View style={styles.step}>
              ...
              <Text style={styles.stepTitle}>
                Get your health score + insights
              </Text>
              <Text style={styles.stepText}>
                Receive personalized BMI analysis and wellness recommendations
              </Text>
            </View>
            <View style={styles.step}>
              ...
              <Text style={styles.stepTitle}>
                Chat with Ez (AI health buddy)
              </Text>
              <Text style={styles.stepText}>
                Get instant answers and ongoing health guidance
              </Text>
            </View>
          </View>
        </View>
          ...
          <View style={styles.dashboardMockup}>
            ...
            <View style={styles.mockupMessage}>
              <Text style={styles.mockupText}>
                I can help explain symptoms, suggest wellness tips, and provide
                health guidance in simple terms.
              </Text>
            </View>
          ...
          <View style={styles.features}>
            <View style={styles.feature}>
              ...
              <Text style={styles.featureText}>
                Get health guidance without fear of judgment
              </Text>
            </View>
            <View style={styles.feature}>
            ...
            <View style={styles.feature}>
              ...
              <Text style={styles.featureText}>
                Get clear explanations in seconds, not hours
              </Text>
            </View>
          </View>
        </View>
        ...
        <LinearGradient colors={["#F0F9FF", "#E0F2FE"]} style={styles.quizCTA}>
          ...
          <Text style={styles.quizText}>
            Take our quick health quiz to get personalized recommendations from
            Ez.
          </Text>
          <TouchableOpacity
        ...
        <View style={styles.section}>
          ...
          <View style={styles.securityContainer}>
            ...
            <Text style={styles.securityDescription}>
              Your health data is encrypted end-to-end and stored securely. You
              have full control over your information and can delete your
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerUpdate}>Updated September 20th, 2025</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
