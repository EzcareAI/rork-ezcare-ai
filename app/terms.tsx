    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.intro}>
          Welcome to EZCare AI. These Terms of Service govern your use of our AI
          health guidance platform. By using our service, you agree to these
          terms.
        </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            EZCare AI provides AI-powered health guidance through our chatbot
            "Ez". Our service offers:
            ...
            {"\n\n"}
            Our service is for educational purposes only and does not constitute
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            IMPORTANT: EZCare AI is not a substitute for professional medical
            advice, diagnosis, or treatment. Always seek the advice of qualified
            healthcare providers with questions about medical conditions. Never
            disregard professional medical advice or delay seeking it because of
            information from our service.
            {"\n\n"}
            In case of medical emergencies, call 911 or your local emergency
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            us of any unauthorized account access{"\n"}• Use the service only
            for lawful purposes
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            subscription at any time{"\n"}• Refunds are provided according to
            our refund policy{"\n"}• Price changes will be communicated 30 days
            in advance
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            EZCare AI and all related content, features, and functionality are
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            uptime. We may temporarily suspend service for maintenance, updates,
            or technical issues. We are not liable for any damages resulting
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            To the maximum extent permitted by law, EZCare AI shall not be
            liable for any indirect, incidental, special, or consequential
            damages arising from your use of our service. Our total liability is
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            settings. Upon termination, your access to the service will cease,
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            notify you of material changes by email or through our service. Your
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            EZCare AI operates. Any disputes will be resolved through binding
        ...
        <View style={styles.footerNote}>
          ...
          <Text style={styles.updateNote}>Updated September 20th, 2025</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
