      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.pricingContainer}>
          {plans.map((plan) => {
            ...
            const isCurrentPlan = user?.subscription_plan === plan.id || (plan.id === 'free' && user?.subscription_plan === 'trial');
        ...
        <View style={styles.faqSection}>
          ...
          <View style={styles.faqItem}>
            ...
            <Text style={styles.faqAnswer}>
              Each message you send to Ez uses 1 credit. You get credits based on your subscription plan.
            </Text>
          </View>
          ...
          <View style={styles.faqItem}>
            ...
            <Text style={styles.faqAnswer}>
              Absolutely. We use enterprise-grade security to protect your health information.
            </Text>
          </View>
        </View>
